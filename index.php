...
define('AIGAION_ROOT_URL','http://localhost:8888/web_publication_manager/');
...
define('AIGAION_SITEID', 'MESVABibliomanager');
# Host where database runs
define('AIGAION_DB_HOST', 'localhost:8888');
# Database user
define('AIGAION_DB_USER', 'root');
# Database password
define('AIGAION_DB_PWD', 'root');
# Name of the standard database
define('AIGAION_DB_NAME', 'db_aigaion2');
...
define('AIGAION_WEBCONTENT_URL','http://localhost:8888/web_publication_manager/webcontent/');
define('AIGAION_WEBCONTENT_DIR','/Applications/MAMP/htdocs/web_publication_manager/webcontent/');
